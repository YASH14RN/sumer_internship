               ...
               <!-- ============================================================== -->
                ...
                <!-- ============================================================== -->
                  <?php 
                    ...
                    $sql = "SELECT * FROM `tbl_payment` WHERE `payment_id`= ? AND document_controlno = ?";
                                    ...
                                    <div class="card influencer-profile-data">
                                        <div class="card-body">
                                            ...
                                            <form id="validationform" name="pay_forms" data-parsley-validate="" novalidate="" method="POST">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Document Control No.</label>
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                        <input data-parsley-type="alphanum" type="text" value="<?= $row['document_controlno']; ?>" name="document_controlno" required="" placeholder="" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                 ...
                                                 <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                        <input data-parsley-type="alphanum" value="<?= strftime('%Y-%m-%d', strtotime($row['date_ofpayment'])); ?>" type="date" name="date_ofpayment" required="" placeholder="" class="form-control">
                                                    </div>
                                                </div>
      ...
      <script>
          document.addEventListener('DOMContentLoaded', () => {
              ...
              btn.addEventListener('click', () => {
                  ...
                  const document_controlno = document.querySelector('input[name=document_controlno]').value;
                  ...
                  data.append('document_controlno', document_controlno);
              ...
              if (document_controlno === '' &&  total_amount ==='' &&  amount_paid ==='' &&  date_ofpayment ==='' &&  proof_ofpayment ===''){
